...
"""
Implementation of a HyperNetwork to generate the weights of a SIREN.
Taken from https://github.com/vsitzmann/siren/blob/master/meta_modules.py.
"""
...
def hyper_weight_init(m, in_features_main_net):
    if hasattr(m, "weight"):
        nn.init.kaiming_normal_(m.weight, a=0, nonlinearity="relu", mode="fan_in")
